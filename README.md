...
| Link | Description  |
| ------ | ------|
| [Bromite Default](https://github.com/MossNotFound/filtrite/releases/latest/download/bromite-default.dat) | Bromite [default filter list](https://github.com/bromite/filters), but generated by this tool|
| [Bromite Mossify](https://github.com/MossNotFound/filtrite/releases/latest/download/bromite-mossify.dat) | Lists I use with [uBlock Origin](https://github.com/gorhill/uBlock) based on [yokoffing's recommended filters](https://github.com/yokoffing/filterlists) meant to compliment DNS-based blockers|
| [Bromite Mossified](https://github.com/MossNotFound/filtrite/releases/latest/download/bromite-mossified.dat) | Same as Mossify but excluding [Block Outsider Intrusion into LAN](https://github.com/gwarser/filter-lists/blob/master/lan-block.txt) as it's known to cause problems with local services|

I recommend pairing this with a DNS-based blocking solution like a self-hosted [Pihole](https://github.com/pi-hole/pi-hole)/[AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) or [NextDNS](https://nextdns.io/) with atleast [OISD_Full](https://oisd.nl/) filterlist enabled.
