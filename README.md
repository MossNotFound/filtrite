...
| [Bromite Mossify](https://github.com/MossNotFound/filtrite/releases/latest/download/bromite-mossify.dat) | Lists I use with [uBlock Origin](https://github.com/gorhill/uBlock) based on [yokoffing's recommended filters](https://github.com/yokoffing/filterlists) |
